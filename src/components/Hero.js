...
const Hero = () => {
  ...
  const imageVariants = {
    ...
    visible: { opacity: 1, scale: 1, transition: { duration: 0.8, type: 'spring', stiffness: 50, delay: 0.4 } }
  };
      ...
      <div className="container hero-container">
        ...
        <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.h2 variants={itemVariants} className="hero-subtitle">
            Saya seorang <span className="text-secondary-accent">Software Developer</span>
          </motion.h2>
          ...
          <motion.div variants={itemVariants} className="hero-socials">
            ...
            <a href="mailto:nisasalsabila23050505@gmail.com" className="social-icon">
        ...
        {/* Foto */}
        <motion.div className="hero-image" variants={imageVariants} initial="hidden" animate="visible">
          {/* Animasi background */}
